...
#
#   ./scripts/check_release_apk.sh build/app/outputs/flutter-apk/app-apkpureprod-release.apk
# ============================================================
...
if [ "${HITS:-0}" != "0" ]; then
  ...
  echo "Rilis WAJIB: flutter build apk --release --flavor apkpureProd (entry default lib/main.dart)"
  exit 1
fi
