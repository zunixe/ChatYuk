...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _register() async {
    ...
    try {
      // 1. Sign up → Supabase buat akun baru, kirim email verifikasi
      ...
      // 2. Simpan data profile untuk dipakai setelah verifikasi + login
      // Data akan di-register saat pertama login setelah verifikasi
