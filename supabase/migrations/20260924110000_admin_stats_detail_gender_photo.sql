...
-- Ringkasan admin: samakan avatar Pengguna Online (foto + gender).
-- Tambah 'id' ke users_active/registered/anonymous (foto via AdminAvatarCircle)
-- dan 'sender_id'/'sender_gender' ke messages_today (ikon gender).
-- Murni aditif; diambil dari definisi live (snapshot @20260914010000).
