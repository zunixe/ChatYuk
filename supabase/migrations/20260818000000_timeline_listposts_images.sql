-- ============================================================
-- ChatYuk Timeline — list_posts v5: tambahkan field images[]
-- (fix: v4 dari timeline_mine.sql tidak mengembalikan kolom
--  images, sehingga post multi-foto tampil hanya foto pertama
--  dan carousel/badge tidak muncul di PostCard)
--
-- CARA APPLY: manual via Supabase Dashboard → SQL Editor
-- (sama seperti timeline_perf.sql / timeline_mine.sql).
-- ============================================================
