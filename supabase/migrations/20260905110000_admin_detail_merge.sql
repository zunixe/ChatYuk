-- Admin Ringkasan: email+id di semua list users + exclude dummy accounts
-- & perangkat-excluded. Merge dari 2 revisi:
--   1) 20260905090000: tambah 'id', id + 'email', email
--   2) 20260905100000: exclude dummy via admin_dummy_uids() (SETOF uuid,
--      referensi WAJIB pakai alias kolom: "select ae from ... ae")
