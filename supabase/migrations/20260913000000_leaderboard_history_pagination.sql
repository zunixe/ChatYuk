-- ============================================================
-- Batch D (P2): pagination leaderboard.
-- Tambah param `row_offset` supaya klien bisa paging (default 0 =
-- perilaku lama, UI tak berubah).
-- ============================================================

drop function if exists public.points_leaderboard(text, int);
