-- ============================================================
-- ChatYuk: admin_stats_detail — tambah info detail
-- - rooms_active: sertakan NAMA room (bukan cuma room_id)
-- - users_*: sertakan ip_address & city (untuk link Google Maps)
-- - messages_today: daftar pesan hari ini (isi + pengirim) agar
--   card "Pesan" bisa diklik & dilihat isinya
-- ============================================================
