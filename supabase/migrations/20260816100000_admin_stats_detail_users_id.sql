-- ============================================================
-- ChatYuk: admin_stats_detail — sertakan id user di users_*
-- Peta admin kini realtime (subscribe postgres_changes ke
-- profiles) dan butuh 'id' untuk mencocokkan event UPDATE/INSERT
-- dengan user yang sudah ada di peta.
-- ============================================================
