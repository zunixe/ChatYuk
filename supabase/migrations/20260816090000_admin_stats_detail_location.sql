-- ============================================================
-- ChatYuk: admin_stats_detail — sertakan koordinat user
-- users_* sebelumnya hanya nickname/gender/age/country/city/
-- ip_address/status/is_registered/last_seen → peta admin tidak
-- menampilkan user GPS (tidak punya ip_address untuk di-resolve).
-- Tambahkan lat, lon, loc_source di keempat query users_*.
-- ============================================================
