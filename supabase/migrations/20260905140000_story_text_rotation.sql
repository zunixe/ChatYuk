-- Rotasi teks story (pinch 2 jari juga memutar). Default 0 radian.

alter table public.stories
add column if not exists text_rotation real not null default 0;
...
create or replace function public.create_story(
  ...
  p_text_rotation real default 0,
...
revoke execute on function
  public.create_story(text,text,real,real,int,int,boolean,real,real,text)
  from public, anon;
