    ...
    public void onFrame(VideoFrame videoFrame) {
        ...
        try (FileOutputStream outputStream = new FileOutputStream(file)) {
            ...
            switch (videoFrame.getRotation()) {
                ...
                case 180:
                case 270:
                    // Downsample bitmap sebelum rotate — resolusi penuh frame
                    // video tidak dibutuhkan untuk JPEG snapshot; mencegah
                    // penggunaan memori berlebih (rekomendasi Play Console:
                    ...
                    opts.inSampleSize = 1;
                    while ((bounds.outWidth / opts.inSampleSize) > 1280
                            || (bounds.outHeight / opts.inSampleSize) > 1280) {
                        opts.inSampleSize *= 2;
                    }
                    Bitmap original = BitmapFactory.decodeFile(file.toString(), opts);
